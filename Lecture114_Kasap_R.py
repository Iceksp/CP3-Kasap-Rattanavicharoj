...
label_from_currency = Label(main_window, text="แปลงสกุลเงินจาก :")
...
label_to_currency = Label(main_window, text="ไปสกุลเงิน :")
...
rate_button = Button(main_window, text="แปลงสกุลเงิน", bg="red", fg="White")
rate_button.bind('<Button-1>', click_on_convert_rate)
rate_button.grid(row=2, column=0, padx=5, pady=5)
text_box_rate = Label(main_window, text=" = ")
text_box_rate.grid(row=2, column=1, padx=5, pady=5)

label_amount = Label(main_window, text="จำนวน")
